...
ForSelect.find_or_initialize_by(value: 'notes_r').update_attributes(facility: '9999', code: 'Roles', value: 'notes_r', text: 'notes_r', option_order: 6, grouper: '')
ForSelect.find_or_initialize_by(value: 'pat_crud').update_attributes(facility: '9999', code: 'Roles', value: 'pat_crud', text: 'pat_crud', option_order: 7, grouper: '')
ForSelect.find_or_initialize_by(value: 'pat_cru').update_attributes(facility: '9999', code: 'Roles', value: 'pat_cru', text: 'pat_cru', option_order: 8, grouper: '')
ForSelect.find_or_initialize_by(value: 'pat_r').update_attributes(facility: '9999', code: 'Roles', value: 'pat_r', text: 'pat_r', option_order: 9, grouper: '')
...
ForSelect.find_or_initialize_by(value: 'trackers_r').update_attributes(facility: '9999', code: 'Roles', value: 'trackers_r', text: 'trackers_r', option_order: 11, grouper: '')
